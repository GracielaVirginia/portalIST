...
<div class="px-6 py-6 max-w-3xl">
  <h1 class="text-2xl font-bold text-purple-700 dark:text-purple-200 mb-4">✎ Editar profesional</h1>
  ...
  <form action="{{ route('profesionales.update', $profesional) }}" method="POST"
    ...
    @method('PUT')
    @include('admin.profesionales._form')
    <div class="text-right">
      <a href="{{ route('profesionales.index') }}" class="px-4 py-2 rounded border mr-2">Cancelar</a>
