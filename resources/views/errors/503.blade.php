...
<body class="min-h-screen flex items-center justify-center bg-purple-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-500">
  <main class="w-full max-w-lg p-8 rounded-2xl bg-white/70 dark:bg-gray-800/60 backdrop-blur-md shadow-xl ring-1 ring-black/10 dark:ring-white/10 text-center">
    <div class="flex flex-col items-center gap-3">
      ...
      <h1 class="text-2xl font-bold text-purple-900 dark:text-purple-300">Servicio no disponible</h1>
    ...
    <p class="mt-2 text-gray-600 dark:text-gray-300">
      El servicio estará disponible en unos minutos.
    </p>
    <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
      ...
      <a href="{{ route('login') }}" class="px-6 py-3 rounded-lg font-semibold border-2 border-purple-900 text-purple-900 hover:bg-purple-900 hover:text-white dark:border-purple-400 dark:text-purple-300 dark:hover:bg-purple-500 dark:hover:text-white transition">
        Intentar nuevamente
      </a>
    </div>
  </main>
