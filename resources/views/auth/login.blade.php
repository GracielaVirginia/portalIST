...
<div class="inline-grid place-items-center h-14 w-14 rounded-2xl overflow-hidden shadow-sm border border-purple-300/40 dark:border-purple-700/40 bg-white dark:bg-gray-800">
    <img src="{{ asset('favicon.ico') }}" alt="Logo IST" class="h-7 w-7 object-contain" />
                            ...
                            {{-- Formulario --}}
                            <form method="POST" id="formLogin" action="{{ route('login.attempt') }}" class="mt-6 space-y-5" novalidate>
                                @csrf
  ...
  <div
    ...
    <div class="mt-3 flex justify-center">
      ...
      <a href="{{ route('soporte.create') }}"
         ...
         onmouseover="this.innerText='Ayuda'"
         onmouseout="this.innerText='Administrador'">
        Administrador
      </a>
    </div>
